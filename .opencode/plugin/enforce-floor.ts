...
const FLOOR = _tunable("/tmp/gludd-floor-override", "CLAUDE_AGENT_FLOOR", "3")
const CEILING = _tunable("/tmp/gludd-ceiling-override", "CLAUDE_AGENT_CEILING", "3")
const TARGET = Math.min(
  parseInt(process.env.CLAUDE_AGENT_TARGET || "3", 10),
  CEILING,
)
      ...
      if (
        ...
        return {
          ...
          message: [
            ...
            "Run the pre-dispatch audit and submit one parallel wave of exactly 3 concrete tasks.",
