...
class TestConcurrency:
    def test_parallel_put_all(self, tmp_path):
        store = ObservationStore(store_path=str(tmp_path / "observations.json"))
        store.clear()
...
class TestFullPipeline:
    def test_consolidate_store_query(self, tmp_path):
    ...
    def test_staleness_pipeline(self, tmp_path):
        consolidate = ObservationConsolidator()
        store = ObservationStore(store_path=str(tmp_path / "observations.json"))
