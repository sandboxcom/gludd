...
def test_run_benchmark_default_sink_flushes_evaluation_and_retry_diagnosis(
    ...
    rotated_attempt_identity = (
        "01cfb24bc30769dbe4da020eb21870c1a08199c50f02301bcb2369a776032b1b"
    )
    assert rotated_attempt_identity not in {
        "c82b17180e087de248e2d4c2b50da5e84e6c3b5afc283ac3ba03179418d9f49a",
        ...
        "afb1addd7caf3e80e20146f8479ae2d1e40548915e5ad8ce20c7884f577e3538",
        "90d1dc7969c68c1e5a54b641c4904dc8943a0661f0c71b5af8542bf688f45ab5",
    }
    attempt_lines = [
        line
        for line in output_lines
