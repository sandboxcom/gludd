...
PLUGIN_TO_TEST = {
    ...
    "enforce-floor-v2": ["test_extended_enforcement_plugins_runtime.py"],
    ...
    "enforce-release-deadline": ["test_extended_enforcement_plugins_runtime.py"],
    "enforce-task-tracking": ["test_enforce_task_tracking_runtime.py"],
    "hot_reload": [
