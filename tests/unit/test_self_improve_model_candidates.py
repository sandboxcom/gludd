...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda value: replace(value, filename="./model.gguf"),
        lambda value: replace(value, filename="models//model.gguf"),
        lambda value: replace(value, filename="model\x00.gguf"),
        lambda value: replace(value, filename=f"{'x' * 2_048}.gguf"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda value: replace(value, model_version="latest"),
