...
class TestGitmodulesFile:
    ...
    def test_each_submodule_has_path_and_url(self):
        content = GITMODULES.read_text()
...
class TestSubmoduleInit:
    ...
    def test_runs_git_submodule_update_init(self):
...
class TestSubmoduleUpdate:
    ...
    def test_runs_git_submodule_update_remote(self):
...
class TestSubmodulePin:
    ...
    def test_checks_out_tag_in_submodule(self):
        recipe = _recipe("submodule-pin")
    ...
    def test_updates_gitmodules(self):
        recipe = _recipe("submodule-pin")
...
class TestSubmoduleIntegration:
    ...
    def test_submodule_init_runs(self):
        """submodule-init should run without error if .gitmodules exists."""
    ...
    def test_submodule_status_runs(self):
    ...
    def test_submodules_are_at_specific_tags(self):
