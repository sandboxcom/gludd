...
COVERAGE_SOURCES = (
    ...
    "*/src/general_ludd/self_improve/azure_containerapp_backend.py",
    "*/src/general_ludd/self_improve/azure_containerapp_transport.py",
    "*/src/general_ludd/self_improve/azure_containerapp_transport_types.py",
