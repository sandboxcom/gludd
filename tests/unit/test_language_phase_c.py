...
class TestBCP47Parsing:
    ...
    def test_simple_two_part(self) -> None:
        from general_ludd.language.locale_data import parse_bcp47
...
class TestLocaleNegotiation:
    ...
    def test_exact_match(self) -> None:
        from general_ludd.language.locale_data import negotiate_locale
...
class TestPluralEvaluation:
    ...
    def test_english_one(self) -> None:
        from general_ludd.language.locale_data import evaluate_plural
...
class TestLocaleLookup:
    ...
    def test_exact_lookup(self) -> None:
        from general_ludd.language.locale_data import get_locale_data
...
class TestPseudolocalization:
    ...
    def test_accented_letters_substituted(self) -> None:
        from general_ludd.language.i18n_data import pseudolocalize
...
'''
    ...
    def test_parses_multiple_entries(self) -> None:
        from general_ludd.language.i18n_data import parse_po
...
class TestPoSerialization:
    ...
    def test_roundtrip_preserves_entries(self) -> None:
        from general_ludd.language.i18n_data import parse_po, serialize_po
    ...
    def test_output_contains_msgid_keyword(self) -> None:
        from general_ludd.language.i18n_data import serialize_po
...
class TestICUPlaceholders:
    ...
    def test_simple_placeholder(self) -> None:
        from general_ludd.language.i18n_data import extract_icu_placeholders
...
class TestHardcodedStringDetection:
    ...
    def test_finds_gettext_calls(self) -> None:
        ...
        from general_ludd.language.i18n_data import find_untranslated_strings
