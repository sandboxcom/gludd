...
_BUILTIN_PROVIDERS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "terraform_provider": "hashicorp/kubernetes",
        "supports_spot": False,
        "sub_hour_billing": False,
        "min_gpu": GPUType.T4,
        "max_gpu": GPUType.H100,
        "pricing": {"t4": 0.0, "a100_80": 0.0},
    },
    {
        "provider": ComputeProvider.TOGETHER_AI,
        "display_name": "Together.ai",
        "terraform_provider": "none (API-only)",
        "supports_spot": False,
        "sub_hour_billing": True,
        "min_gpu": GPUType.A100_40,
        "max_gpu": GPUType.H100,
        "pricing": {"a100_40": 1.50, "a100_80": 1.90, "h100": 2.50},
        "auth_env": ["TOGETHER_API_KEY"],
        "auth_source": "OpenBao / SecretsManager",
    },
    {
        "provider": ComputeProvider.FIREWORKS_AI,
    ...
    },
    {
        ...
        "display_name": "HuggingFace Inference Endpoints",
        "terraform_provider": "none (API-only)",
        "supports_spot": False,
        "sub_hour_billing": True,
        "min_gpu": GPUType.T4,
        "max_gpu": GPUType.A100_80,
        "pricing": {"t4": 0.60, "a10g": 1.30, "a100_80": 4.00},
        "auth_env": ["HF_TOKEN"],
        "auth_source": "OpenBao / SecretsManager",
    },
    {
        ...
        "min_gpu": GPUType.T4,
        "max_gpu": GPUType.A100_80,
        "pricing": {"t4": 0.50, "a40": 0.80, "a100_40": 1.15, "a100_80": 1.60},
