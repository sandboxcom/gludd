...
These immutable value objects describe infrastructure placement evidence.  They
are owned by the infrastructure layer so universal workloads can consume them
without depending on the self-improvement subsystem.
"""
