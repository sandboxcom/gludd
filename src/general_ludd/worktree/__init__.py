...
def parse_agents_md_markdown(content: str) -> AgentsMdResult:
    ...
    in_description_section = True  # Start by collecting text after title as description
    desc_lines: list[str] = []
...
class WorktreeMonitor:
    ...
    def evaluate(self) -> list[dict[str, object]]:
        ...
        Returns list of dicts with todo fields for abandoned worktrees
        that have AGENTS.md directives and no existing pending todo.
        """
