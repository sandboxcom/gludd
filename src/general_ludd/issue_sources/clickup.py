...
class ClickUpIssueSource:
    ...
    # -- normalization ---------------------------------------------------
    def _normalize(self, task: Mapping[str, Any]) -> dict[str, Any]:
