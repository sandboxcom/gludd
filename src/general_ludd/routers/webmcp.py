...
_ENDPOINTS: list[dict[str, object]] = [
    ...
    },
    {
        "method": "GET",
        "path": "/docs",
        "purpose": "Interactive OpenAPI documentation generated by FastAPI.",
        "auth_required": False,
    },
    {
        "method": "GET",
        "path": "/openapi.json",
        "purpose": "Machine-readable OpenAPI schema generated by FastAPI.",
        "auth_required": False,
    },
    {
        "method": "GET",
        "path": "/redoc",
        "purpose": "ReDoc rendering of the daemon OpenAPI schema.",
        "auth_required": False,
    },
    # ── Facts / observability ────────────────────────────────────────────────
    {
        ...
        "response_shape": {
            ...
            "coordination": "object — current inter-agent coordination snapshot",
            "osquery": "object — read-only osquery availability and system-state facts",
    ...
    {
        "method": "GET",
        "path": "/api/human-todos",
        "purpose": "List human-action requests with bounded filtering and pagination.",
        "auth_required": False,
        "query_params": {
            "status": "string | null",
            ...
            "agent_id": "string | null",
            "limit": "int — bounded to 1-500 (default 100)",
            "offset": "int — non-negative pagination offset",
        },
        "response_shape": "array of human-todo objects",
    },
    # ── Messages ─────────────────────────────────────────────────────────────
    {
        "method": "POST",
    ...
    },
    {
        ...
        "auth_required": True,
        "request_body": {
            "body": "none — message_id is a path parameter; project_id is an optional query parameter",
        },
        "response_shape": {
    ...
    },
    {
        ...
        "request_body": {
            "body": "none — project_id is an optional query parameter",
        },
        "response_shape": {
            "summary": "object — verification totals excluding individual results",
            "results": "array — per-feature evidence and resulting status",
        },
    },
    # ── Deployments ──────────────────────────────────────────────────────────
    {
    ...
    },
    {
        ...
        "response_shape": {
            "configured": "bool — true after the replacement limiter is installed",
            "limit_usd": "float — effective spend cap",
            "window_seconds": "float — effective rolling-window width",
        },
    },
    # ── Accounting ───────────────────────────────────────────────────────────
    {
