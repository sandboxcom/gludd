...
class SplunkObservabilitySource:
    ...
    def _query_signalflow(self, spec: dict[str, Any]) -> list[dict[str, Any]]:
        url = f"{self._base_url}/v2/signalflow"
        body: dict[str, Any] = {"program": spec["program"]}
    ...
    def _query_timeserieswindow(self, spec: dict[str, Any]) -> list[dict[str, Any]]:
