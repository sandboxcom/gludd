...
**Enforcement:** AGENTS.md `.github/workflows/build.yml:artifact-upload` CI workflow enforcement; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make container-run` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make floor-status` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make gate-kill` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make test-guardrails` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make verify-enforcement` CI+local dual; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` × `.opencode/plugin/enforce-deletion-gate.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-context.ts` × `.opencode/plugin/enforce-verified-claims.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-delegate.ts` + `make tf-cache-warm` combined guard; AGENTS.md `.opencode/plugin/enforce-deletion-gate.ts` + `make test-and-commit` combined guard; AGENTS.md `.opencode/plugin/enforce-enhancement-ratio.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-floor.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-make.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-multitask.ts` × `.opencode/plugin/enforce-session-start.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` × `.opencode/plugin/enforce-no-wait.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` `tool.execute.after` block; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-session-start.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-stop.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-tdd.ts` × `.opencode/plugin/enforce-objective.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-test-integrity.ts` + `make git-checkout` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` + `make validate` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` env-var-gated BLOCKING; AGENTS.md `/tmp/gludd-ci-check-state.json` + `.opencode/plugin/enforce-test-integrity.ts` state-aware block; AGENTS.md `/tmp/gludd-enhancement-ratio.json` state-file enforced block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-branch-discipline.ts` state-aware block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-no-wait.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-delegate.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-session-start.ts` state-aware block; AGENTS.md `/tmp/gludd-tool-streak.json` state-file enforced block; AGENTS.md `/tmp/gludd-user-objective.json` state-file enforced block; AGENTS.md `10-Agent Dispatch Floor` + Makefile `make collect-check` combined; AGENTS.md `Anti-Grinding Enforcement` + Makefile `make git-merge` combined; AGENTS.md `Background Operations NEVER Block Dispatch` section; AGENTS.md `Hard Break Enforcement` + `scripts/stop_condition_audit.py` + `.opencode/plugin/enforce-session-start.ts` triple layer; AGENTS.md `Judgment Enforcement` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-verified-claims.ts` triple layer; AGENTS.md `No-Manual-Default Policy` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-no-wait.ts` triple layer; AGENTS.md `Node v26 Compatibility` section; AGENTS.md `Nothing-Dropped Guardrail` + Makefile `make clean-worktree-venvs` combined; AGENTS.md `Pre-Generation Contract` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-objective.ts` triple layer; AGENTS.md `Premature-Stop Audit Policy` + Makefile `make agent-merge` combined; AGENTS.md `Premature-Stop Audit Policy` section; AGENTS.md `Priority Stacking` section; AGENTS.md `Release Pipeline Must Be CI-Green` + Makefile `make test-integration` combined; AGENTS.md `Task Self-Tracking` section; AGENTS.md `Yield Enforcement` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-enhancement-ratio.ts` triple layer; AGENTS.md `config/ratchet.yml:coverage-baseline` + `scripts/check_readme_status_current.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:dead-code` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:dirty-tree` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:duplicate-target` + `scripts/check_node_v26_compat.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:stale-gate` + `scripts/test_hook_runtime.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:typecheck-baseline` ratchet-tracked gate; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-context.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-floor.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` enforcement; AGENTS.md `scripts/require_ci_green.py` + `.opencode/plugin/enforce-clean-tree.ts` dual layer; AGENTS.md `scripts/require_ci_green.py` enforcement; AGENTS.md `scripts/task_watchdog.py` + `.opencode/plugin/enforce-batch-push.ts` dual layer; AGENTS.md `scripts/task_watchdog.py` enforcement; AGENTS.md `tests/unit/test_behavioral_specs.py` structural assertion gate; AGENTS.md `tests/unit/test_blocker_detector.py` structural assertion gate; AGENTS.md `tests/unit/test_no_suppression_comments.py` structural assertion gate; AGENTS.md `tests/unit/test_require_ci_green.py` structural assertion gate; AGENTS.md `tests/unit/test_verified_claims_plugin.py` structural assertion gate; Makefile `make agent-cleanup` fail-closed guard; Makefile `make agent-worktree-list` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make check-types` + `scripts/test_hook_runtime.py` script-backed guard; Makefile `make container-push` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make container-run` prerequisite; Makefile `make development-start` fail-closed guard; Makefile `make disengage-enforcement` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make feature-start` fail-closed guard; Makefile `make gated-merge` fail-closed guard; Makefile `make git-rebranch-onto` prerequisite; Makefile `make git-reset` prerequisite; Makefile `make git-stash-pop` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make tf-init` prerequisite
**Test:** `test_p31_push_discipline_guard_31`

### B26 — Branch creation must verify working tree is clean first
The agent MUST enforce this invariant mechanically at runtime — no advisory-only, no opt-in.
**Enforcement:** AGENTS.md `.github/workflows/build.yml:artifact-upload` CI workflow enforcement; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make container-run` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make floor-status` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make gate-kill` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make test-guardrails` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make verify-enforcement` CI+local dual; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` × `.opencode/plugin/enforce-deletion-gate.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-context.ts` × `.opencode/plugin/enforce-verified-claims.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-delegate.ts` + `make tf-cache-warm` combined guard; AGENTS.md `.opencode/plugin/enforce-deletion-gate.ts` + `make test-and-commit` combined guard; AGENTS.md `.opencode/plugin/enforce-enhancement-ratio.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-floor.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-make.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-multitask.ts` × `.opencode/plugin/enforce-session-start.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` × `.opencode/plugin/enforce-no-wait.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` `tool.execute.after` block; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-objective.ts` + `make require-ci-green` combined guard; AGENTS.md `.opencode/plugin/enforce-session-start.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-stop.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-tdd.ts` × `.opencode/plugin/enforce-objective.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-test-integrity.ts` + `make git-checkout` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` + `make validate` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` env-var-gated BLOCKING; AGENTS.md `/tmp/gludd-ci-check-state.json` + `.opencode/plugin/enforce-test-integrity.ts` state-aware block; AGENTS.md `/tmp/gludd-enhancement-ratio.json` state-file enforced block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-branch-discipline.ts` state-aware block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-no-wait.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-delegate.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-session-start.ts` state-aware block; AGENTS.md `/tmp/gludd-tool-streak.json` state-file enforced block; AGENTS.md `/tmp/gludd-user-objective.json` state-file enforced block; AGENTS.md `10-Agent Dispatch Floor` + Makefile `make collect-check` combined; AGENTS.md `Anti-Grinding Enforcement` + Makefile `make git-merge` combined; AGENTS.md `Background Operations NEVER Block Dispatch` section; AGENTS.md `Hard Break Enforcement` + `scripts/stop_condition_audit.py` + `.opencode/plugin/enforce-session-start.ts` triple layer; AGENTS.md `Judgment Enforcement` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-verified-claims.ts` triple layer; AGENTS.md `No-Manual-Default Policy` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-no-wait.ts` triple layer; AGENTS.md `Node v26 Compatibility` section; AGENTS.md `Nothing-Dropped Guardrail` + Makefile `make clean-worktree-venvs` combined; AGENTS.md `Pre-Generation Contract` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-objective.ts` triple layer; AGENTS.md `Premature-Stop Audit Policy` + Makefile `make agent-merge` combined; AGENTS.md `Premature-Stop Audit Policy` section; AGENTS.md `Priority Stacking` section; AGENTS.md `Release Pipeline Must Be CI-Green` + Makefile `make test-integration` combined; AGENTS.md `Task Self-Tracking` section; AGENTS.md `Yield Enforcement` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-enhancement-ratio.ts` triple layer; AGENTS.md `config/ratchet.yml:coverage-baseline` + `scripts/check_readme_status_current.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:dead-code` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:dirty-tree` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:duplicate-target` + `scripts/check_node_v26_compat.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:stale-gate` + `scripts/test_hook_runtime.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:typecheck-baseline` ratchet-tracked gate; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-context.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-floor.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` enforcement; AGENTS.md `scripts/require_ci_green.py` + `.opencode/plugin/enforce-clean-tree.ts` dual layer; AGENTS.md `scripts/require_ci_green.py` + `.opencode/plugin/enforce-multitask.ts` dual layer; AGENTS.md `scripts/require_ci_green.py` enforcement; AGENTS.md `scripts/task_watchdog.py` + `.opencode/plugin/enforce-batch-push.ts` dual layer; AGENTS.md `scripts/task_watchdog.py` enforcement; AGENTS.md `tests/unit/test_behavioral_specs.py` structural assertion gate; AGENTS.md `tests/unit/test_blocker_detector.py` structural assertion gate; AGENTS.md `tests/unit/test_no_suppression_comments.py` structural assertion gate; AGENTS.md `tests/unit/test_require_ci_green.py` structural assertion gate; AGENTS.md `tests/unit/test_verified_claims_plugin.py` structural assertion gate; Makefile `make agent-cleanup` fail-closed guard; Makefile `make agent-worktree-list` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make check-types` + `scripts/test_hook_runtime.py` script-backed guard; Makefile `make container-push` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make container-run` prerequisite; Makefile `make development-start` fail-closed guard; Makefile `make disengage-enforcement` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make feature-start` fail-closed guard; Makefile `make gated-merge` fail-closed guard; Makefile `make git-rebranch-onto` prerequisite; Makefile `make git-reset` prerequisite; Makefile `make git-stash-pop` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make tf-init` prerequisite
...
The agent MUST enforce this invariant mechanically at runtime — no advisory-only, no opt-in.
**Enforcement:** AGENTS.md `.github/workflows/build.yml:artifact-upload` CI workflow enforcement; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make container-run` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make floor-status` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make gate-kill` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make test-guardrails` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make verify-enforcement` CI+local dual; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` × `.opencode/plugin/enforce-deletion-gate.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-context.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-context.ts` × `.opencode/plugin/enforce-verified-claims.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-delegate.ts` + `make tf-cache-warm` combined guard; AGENTS.md `.opencode/plugin/enforce-deletion-gate.ts` + `make test-and-commit` combined guard; AGENTS.md `.opencode/plugin/enforce-enhancement-ratio.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-floor.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-make.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-multitask.ts` × `.opencode/plugin/enforce-session-start.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` × `.opencode/plugin/enforce-no-wait.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` `tool.execute.after` block; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-session-start.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-stop.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-tdd.ts` × `.opencode/plugin/enforce-objective.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-test-integrity.ts` + `make git-checkout` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` + `make validate` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` env-var-gated BLOCKING; AGENTS.md `/tmp/gludd-ci-check-state.json` + `.opencode/plugin/enforce-test-integrity.ts` state-aware block; AGENTS.md `/tmp/gludd-enhancement-ratio.json` state-file enforced block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-branch-discipline.ts` state-aware block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-no-wait.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-delegate.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-session-start.ts` state-aware block; AGENTS.md `/tmp/gludd-tool-streak.json` state-file enforced block; AGENTS.md `/tmp/gludd-user-objective.json` state-file enforced block; AGENTS.md `10-Agent Dispatch Floor` + Makefile `make collect-check` combined; AGENTS.md `Anti-Grinding Enforcement` + Makefile `make git-merge` combined; AGENTS.md `Background Operations NEVER Block Dispatch` section; AGENTS.md `Hard Break Enforcement` + `scripts/stop_condition_audit.py` + `.opencode/plugin/enforce-session-start.ts` triple layer; AGENTS.md `Judgment Enforcement` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-verified-claims.ts` triple layer; AGENTS.md `No-Manual-Default Policy` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-no-wait.ts` triple layer; AGENTS.md `Node v26 Compatibility` section; AGENTS.md `Nothing-Dropped Guardrail` + Makefile `make clean-worktree-venvs` combined; AGENTS.md `Pre-Generation Contract` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-objective.ts` triple layer; AGENTS.md `Premature-Stop Audit Policy` + Makefile `make agent-merge` combined; AGENTS.md `Premature-Stop Audit Policy` section; AGENTS.md `Priority Stacking` section; AGENTS.md `Release Pipeline Must Be CI-Green` + Makefile `make test-integration` combined; AGENTS.md `Task Self-Tracking` section; AGENTS.md `Yield Enforcement` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-enhancement-ratio.ts` triple layer; AGENTS.md `config/ratchet.yml:coverage-baseline` + `scripts/check_readme_status_current.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:dead-code` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:dirty-tree` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:duplicate-target` + `scripts/check_node_v26_compat.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:stale-gate` + `scripts/test_hook_runtime.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:typecheck-baseline` ratchet-tracked gate; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-context.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-floor.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` enforcement; AGENTS.md `scripts/require_ci_green.py` + `.opencode/plugin/enforce-clean-tree.ts` dual layer; AGENTS.md `scripts/require_ci_green.py` enforcement; AGENTS.md `scripts/task_watchdog.py` + `.opencode/plugin/enforce-batch-push.ts` dual layer; AGENTS.md `scripts/task_watchdog.py` enforcement; AGENTS.md `tests/unit/test_behavioral_specs.py` structural assertion gate; AGENTS.md `tests/unit/test_blocker_detector.py` structural assertion gate; AGENTS.md `tests/unit/test_no_suppression_comments.py` structural assertion gate; AGENTS.md `tests/unit/test_require_ci_green.py` structural assertion gate; AGENTS.md `tests/unit/test_verified_claims_plugin.py` structural assertion gate; Makefile `make agent-cleanup` fail-closed guard; Makefile `make agent-worktree-list` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make check-duplicate-targets` fail-closed guard; Makefile `make check-opencode-backup` prerequisite; Makefile `make check-types` + `scripts/test_hook_runtime.py` script-backed guard; Makefile `make container-push` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make container-run` prerequisite; Makefile `make development-start` fail-closed guard; Makefile `make disengage-enforcement` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make feature-start` fail-closed guard; Makefile `make gated-merge` fail-closed guard; Makefile `make git-rebranch-onto` prerequisite; Makefile `make git-reset` prerequisite; Makefile `make git-stash-pop` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make tf-init` prerequisite
...
The agent MUST enforce this invariant mechanically at runtime — no advisory-only, no opt-in.
**Enforcement:** AGENTS.md `.github/workflows/build.yml:artifact-upload` CI workflow enforcement; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make feature-start` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make git-stash` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make git-status` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make preflight` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make release-cut` CI+local dual; AGENTS.md `.opencode/plugin/enforce-audit.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-batch-push.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-batch-push.ts` × `.opencode/plugin/enforce-enhancement-ratio.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-branch-discipline.ts` + `make git-staged` combined guard; AGENTS.md `.opencode/plugin/enforce-clean-tree.ts` × `.opencode/plugin/enforce-stop.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-context.ts` × `.opencode/plugin/enforce-verified-claims.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-deadline.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-deletion-gate.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-enhancement-ratio.ts` + `make lint` combined guard; AGENTS.md `.opencode/plugin/enforce-floor.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-floor.ts` × `.opencode/plugin/enforce-delegate.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-make.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-multitask.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-multitask.ts` × `.opencode/plugin/enforce-session-start.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` + `make verify-state` combined guard; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` `tool.execute.after` block; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-objective.ts` + `make test-unit` combined guard; AGENTS.md `.opencode/plugin/enforce-objective.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-session-start.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-tdd.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-test-integrity.ts` + `make ci-cooldown-status` combined guard; AGENTS.md `/tmp/gludd-ci-check-state.json` + `.opencode/plugin/enforce-no-wait.ts` state-aware block; AGENTS.md `/tmp/gludd-ci-check-state.json` + `.opencode/plugin/enforce-stop.ts` state-aware block; AGENTS.md `/tmp/gludd-enhancement-ratio.json` state-file enforced block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-delegate.ts` state-aware block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-deletion-gate.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-objective.ts` state-aware block; AGENTS.md `/tmp/gludd-tool-streak.json` state-file enforced block; AGENTS.md `/tmp/gludd-user-objective.json` state-file enforced block; AGENTS.md `Agent At-Rest Policy` + Makefile `make container-build` combined; AGENTS.md `Constraints Are To Engineer Around` + Makefile `make lint-fix` combined; AGENTS.md `Fix Means Repair Never Disable` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-enhancement-ratio.ts` triple layer; AGENTS.md `Keep Opus Lean` + Makefile `make git-commit` combined; AGENTS.md `Long-Running Operations MUST Be Backgrounded` section; AGENTS.md `Model Utilization` section; AGENTS.md `Never Block on Questions` + `scripts/stop_condition_audit.py` + `.opencode/plugin/enforce-delegate.ts` triple layer; AGENTS.md `No Lint-Suppression Comments` + `scripts/stop_condition_audit.py` + `.opencode/plugin/enforce-verified-claims.ts` triple layer; AGENTS.md `Node v26 Compatibility` + Makefile `make check-obj-progress` combined; AGENTS.md `Nothing-Dropped Guardrail` section; AGENTS.md `Release Branch Lifecycle` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-stop.ts` triple layer; AGENTS.md `Release Cut = Update README` + Makefile `make verify-plugin-manifest` combined; AGENTS.md `Release Cut = Update README` section; AGENTS.md `TDD Policy` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-test-integrity.ts` triple layer; AGENTS.md `Verification Enforcement` section; AGENTS.md `config/ratchet.yml:coverage-baseline` + `scripts/check_readme_status_current.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:dead-code` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:dirty-tree` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:duplicate-target` + `scripts/check_node_v26_compat.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:stale-gate` + `scripts/test_hook_runtime.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:typecheck-baseline` ratchet-tracked gate; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-anti-essay.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-multitask.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` enforcement; AGENTS.md `scripts/require_ci_green.py` + `.opencode/plugin/enforce-no-suppressions.ts` dual layer; AGENTS.md `scripts/require_ci_green.py` enforcement; AGENTS.md `scripts/task_watchdog.py` + `.opencode/plugin/enforce-context.ts` dual layer; AGENTS.md `scripts/task_watchdog.py` + `.opencode/plugin/enforce-tdd.ts` dual layer; AGENTS.md `scripts/task_watchdog.py` enforcement; AGENTS.md `tests/e2e/test_cli_workflow.py` structural assertion gate; AGENTS.md `tests/unit/test_blocker_detector.py` structural assertion gate; AGENTS.md `tests/unit/test_clean_tree_plugin.py` structural assertion gate; AGENTS.md `tests/unit/test_no_suppression_comments.py` structural assertion gate; AGENTS.md `tests/unit/test_require_ci_green.py` structural assertion gate; Makefile `make agent-cleanup` prerequisite; Makefile `make ansible-syntax` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make batch-push` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make check-duplicate-targets` prerequisite; Makefile `make check-opencode-backup` fail-closed guard; Makefile `make development-push` + `scripts/test_hook_runtime.py` script-backed guard; Makefile `make floor-status` fail-closed guard; Makefile `make gate-background` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make gate-kill` prerequisite; Makefile `make gate` prerequisite; Makefile `make gated-merge` prerequisite; Makefile `make git-diff` + `scripts/test_hook_runtime.py` script-backed guard; Makefile `make reload-enforcement` fail-closed guard; Makefile `make test-e2e` prerequisite; Makefile `make tf-init` fail-closed guard; Makefile `make verify-enforcement` fail-closed guard; Makefile `make watchdog-auto` fail-closed guard
**Test:** `test_e21_essay_prevention_21`

### M21 — merge_safety enforcement guard #21: automated unique mechanism
The agent MUST enforce this invariant mechanically at runtime — no advisory-only, no opt-in.
**Enforcement:** AGENTS.md `.github/workflows/build.yml:artifact-upload` CI workflow enforcement; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make container-run` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make floor-status` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make gate-kill` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make test-guardrails` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make verify-enforcement` CI+local dual; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` × `.opencode/plugin/enforce-deletion-gate.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-batch-push.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-context.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-context.ts` × `.opencode/plugin/enforce-verified-claims.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-delegate.ts` + `make tf-cache-warm` combined guard; AGENTS.md `.opencode/plugin/enforce-deletion-gate.ts` + `make test-and-commit` combined guard; AGENTS.md `.opencode/plugin/enforce-enhancement-ratio.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-floor.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-make.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-multitask.ts` × `.opencode/plugin/enforce-session-start.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` × `.opencode/plugin/enforce-no-wait.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` `tool.execute.after` block; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-objective.ts` + `make require-ci-green` combined guard; AGENTS.md `.opencode/plugin/enforce-session-start.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-stop.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-tdd.ts` × `.opencode/plugin/enforce-objective.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-test-integrity.ts` + `make git-checkout` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` + `make validate` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` env-var-gated BLOCKING; AGENTS.md `/tmp/gludd-ci-check-state.json` + `.opencode/plugin/enforce-test-integrity.ts` state-aware block; AGENTS.md `/tmp/gludd-enhancement-ratio.json` state-file enforced block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-branch-discipline.ts` state-aware block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-no-wait.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-delegate.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-session-start.ts` state-aware block; AGENTS.md `/tmp/gludd-tool-streak.json` state-file enforced block; AGENTS.md `/tmp/gludd-user-objective.json` state-file enforced block; AGENTS.md `10-Agent Dispatch Floor` + Makefile `make collect-check` combined; AGENTS.md `Anti-Grinding Enforcement` + Makefile `make git-merge` combined; AGENTS.md `Background Operations NEVER Block Dispatch` section; AGENTS.md `Hard Break Enforcement` + `scripts/stop_condition_audit.py` + `.opencode/plugin/enforce-session-start.ts` triple layer; AGENTS.md `Judgment Enforcement` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-verified-claims.ts` triple layer; AGENTS.md `No-Manual-Default Policy` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-no-wait.ts` triple layer; AGENTS.md `Node v26 Compatibility` section; AGENTS.md `Nothing-Dropped Guardrail` + Makefile `make clean-worktree-venvs` combined; AGENTS.md `Pre-Generation Contract` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-objective.ts` triple layer; AGENTS.md `Premature-Stop Audit Policy` + Makefile `make agent-merge` combined; AGENTS.md `Premature-Stop Audit Policy` section; AGENTS.md `Priority Stacking` section; AGENTS.md `Release Pipeline Must Be CI-Green` + Makefile `make test-integration` combined; AGENTS.md `Task Self-Tracking` section; AGENTS.md `Yield Enforcement` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-enhancement-ratio.ts` triple layer; AGENTS.md `config/ratchet.yml:coverage-baseline` + `scripts/check_readme_status_current.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:dead-code` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:dirty-tree` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:duplicate-target` + `scripts/check_node_v26_compat.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:stale-gate` + `scripts/test_hook_runtime.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:typecheck-baseline` ratchet-tracked gate; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-context.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-floor.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` enforcement; AGENTS.md `scripts/require_ci_green.py` + `.opencode/plugin/enforce-clean-tree.ts` dual layer; AGENTS.md `scripts/require_ci_green.py` + `.opencode/plugin/enforce-multitask.ts` dual layer; AGENTS.md `scripts/require_ci_green.py` enforcement; AGENTS.md `scripts/task_watchdog.py` + `.opencode/plugin/enforce-batch-push.ts` dual layer; AGENTS.md `scripts/task_watchdog.py` enforcement; AGENTS.md `tests/unit/test_behavioral_specs.py` structural assertion gate; AGENTS.md `tests/unit/test_blocker_detector.py` structural assertion gate; AGENTS.md `tests/unit/test_no_suppression_comments.py` structural assertion gate; AGENTS.md `tests/unit/test_require_ci_green.py` structural assertion gate; AGENTS.md `tests/unit/test_verified_claims_plugin.py` structural assertion gate; Makefile `make agent-cleanup` fail-closed guard; Makefile `make agent-worktree-list` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make check-duplicate-targets` fail-closed guard; Makefile `make check-opencode-backup` prerequisite; Makefile `make check-types` + `scripts/test_hook_runtime.py` script-backed guard; Makefile `make container-push` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make container-run` prerequisite; Makefile `make development-start` fail-closed guard; Makefile `make disengage-enforcement` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make feature-start` fail-closed guard; Makefile `make gated-merge` fail-closed guard; Makefile `make git-index` fail-closed guard; Makefile `make git-rebranch-onto` prerequisite; Makefile `make git-reset` prerequisite; Makefile `make git-stash-pop` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make release-cut` prerequisite; Makefile `make tf-init` prerequisite
...
The agent MUST enforce this invariant mechanically at runtime — no advisory-only, no opt-in.
**Enforcement:** AGENTS.md `.github/workflows/build.yml:artifact-upload` CI workflow enforcement; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make gate-kill` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make git-rebranch-onto` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make git-show` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make secrets-scrub` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make test-guardrails` CI+local dual; AGENTS.md `.github/workflows/build.yml:build-macos` + Makefile `make verify-release-completeness` CI+local dual; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-anti-essay.ts` × `.opencode/plugin/enforce-deletion-gate.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-batch-push.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-context.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-context.ts` × `.opencode/plugin/enforce-verified-claims.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-deadline.ts` × `.opencode/plugin/enforce-audit.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-delegate.ts` + `make ci-verdict` combined guard; AGENTS.md `.opencode/plugin/enforce-delegate.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-deletion-gate.ts` + `make agent-worktree` combined guard; AGENTS.md `.opencode/plugin/enforce-enhancement-ratio.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-floor.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-make.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-multitask.ts` × `.opencode/plugin/enforce-session-start.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` permissionDecision deny; AGENTS.md `.opencode/plugin/enforce-no-suppressions.ts` × `.opencode/plugin/enforce-no-wait.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` `tool.execute.after` block; AGENTS.md `.opencode/plugin/enforce-no-wait.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-objective.ts` + `make test-and-commit` combined guard; AGENTS.md `.opencode/plugin/enforce-session-start.ts` + `make security` combined guard; AGENTS.md `.opencode/plugin/enforce-session-start.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-stop.ts` env-var-gated BLOCKING; AGENTS.md `.opencode/plugin/enforce-tdd.ts` × `.opencode/plugin/enforce-objective.ts` cross-plugin; AGENTS.md `.opencode/plugin/enforce-test-integrity.ts` + `make tf-cache-warm` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` + `make write-plugin-manifest` combined guard; AGENTS.md `.opencode/plugin/enforce-verified-claims.ts` env-var-gated BLOCKING; AGENTS.md `/tmp/gludd-ci-check-state.json` + `.opencode/plugin/enforce-test-integrity.ts` state-aware block; AGENTS.md `/tmp/gludd-ci-check-state.json` + `.opencode/plugin/enforce-verified-claims.ts` state-aware block; AGENTS.md `/tmp/gludd-enhancement-ratio.json` state-file enforced block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-branch-discipline.ts` state-aware block; AGENTS.md `/tmp/gludd-floor-override` + `.opencode/plugin/enforce-no-wait.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-delegate.ts` state-aware block; AGENTS.md `/tmp/gludd-task-killed.json` + `.opencode/plugin/enforce-session-start.ts` state-aware block; AGENTS.md `/tmp/gludd-tool-streak.json` state-file enforced block; AGENTS.md `/tmp/gludd-user-objective.json` state-file enforced block; AGENTS.md `A Release is an Artifact` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-enhancement-ratio.ts` triple layer; AGENTS.md `Anti-Grinding Enforcement` section; AGENTS.md `Bash Command Policy` + Makefile `make secrets-scan` combined; AGENTS.md `Branch discipline` section; AGENTS.md `Commit-After-Green Policy` + Makefile `make git-mv` combined; AGENTS.md `Don't Push Every Commit` + Makefile `make agent-merge` combined; AGENTS.md `Evidence-Based Response Policy` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-objective.ts` triple layer; AGENTS.md `Guardrail Integrity Policy` section; AGENTS.md `Keep Opus Lean` section; AGENTS.md `Multitasking / Blockers` + `scripts/verify_release_artifact.py` + `.opencode/plugin/enforce-verified-claims.ts` triple layer; AGENTS.md `No-Commit-Bypass Policy` + `scripts/stop_condition_audit.py` + `.opencode/plugin/enforce-deletion-gate.ts` triple layer; AGENTS.md `Priority Stacking` + Makefile `make agent-merge-dev` combined; AGENTS.md `Q&A Response Pattern` + Makefile `make restore-opencode` combined; AGENTS.md `Q&A Response Pattern` section; AGENTS.md `Self-Audit Policy` + `scripts/stop_condition_audit.py` + `.opencode/plugin/enforce-session-start.ts` triple layer; AGENTS.md `Session Persistence Policy` + `scripts/check_duplicate_targets.py` + `.opencode/plugin/enforce-no-wait.ts` triple layer; AGENTS.md `Single-Source Feature Development` + Makefile `make test-integration` combined; AGENTS.md `Verification Before Claim` section; AGENTS.md `config/ratchet.yml:coverage-baseline` + `scripts/check_readme_status_current.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:dead-code` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:dirty-tree` ratchet-tracked gate; AGENTS.md `config/ratchet.yml:duplicate-target` + `scripts/check_node_v26_compat.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:stale-gate` + `scripts/test_hook_runtime.py` ratchet+script gate; AGENTS.md `config/ratchet.yml:typecheck-baseline` ratchet-tracked gate; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-context.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` + `.opencode/plugin/enforce-floor.ts` dual layer; AGENTS.md `scripts/check_tdd_compliance.py` enforcement; AGENTS.md `scripts/require_ci_green.py` + `.opencode/plugin/enforce-clean-tree.ts` dual layer; AGENTS.md `scripts/require_ci_green.py` + `.opencode/plugin/enforce-multitask.ts` dual layer; AGENTS.md `scripts/require_ci_green.py` enforcement; AGENTS.md `scripts/task_watchdog.py` + `.opencode/plugin/enforce-batch-push.ts` dual layer; AGENTS.md `scripts/task_watchdog.py` + `.opencode/plugin/enforce-worktree.ts` dual layer; AGENTS.md `scripts/task_watchdog.py` enforcement; AGENTS.md `tests/integration/test_daemon_health.py` structural assertion gate; AGENTS.md `tests/unit/test_clean_tree_plugin.py` structural assertion gate; AGENTS.md `tests/unit/test_human_todo.py` structural assertion gate; AGENTS.md `tests/unit/test_no_wait_plugin.py` structural assertion gate; AGENTS.md `tests/unit/test_session_start.py` structural assertion gate; AGENTS.md `tests/unit/test_stop_pattern_qa.py` structural assertion gate; Makefile `make agent-cleanup` fail-closed guard; Makefile `make agent-worktree-list` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make check-duplicate-targets` fail-closed guard; Makefile `make check-opencode-backup` prerequisite; Makefile `make ci-wait` fail-closed guard; Makefile `make feature-start` fail-closed guard; Makefile `make git-reset` prerequisite; Makefile `make git-stash-pop` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make git-status` prerequisite; Makefile `make pip-audit` + `scripts/check_node_v26_compat.py` script-backed guard; Makefile `make release-cut` fail-closed guard; Makefile `make release-promote` + `scripts/test_hook_runtime.py` script-backed guard; Makefile `make secrets-scrub` prerequisite; Makefile `make test-hook-runtime` + `scripts/check_readme_status_current.py` script-backed guard; Makefile `make tf-init` prerequisite; Makefile `make verify-enforcement` prerequisite; Makefile `make verify-opencode-backup` + `scripts/test_hook_runtime.py` script-backed guard; Makefile `make verify-release-completeness` fail-closed guard
