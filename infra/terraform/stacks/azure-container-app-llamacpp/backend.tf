...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/azure-container-app-llamacpp"
    lock_address = "http://localhost:8400/api/terraform/state/azure-container-app-llamacpp"
    unlock_address = "http://localhost:8400/api/terraform/state/azure-container-app-llamacpp"
  }
}
