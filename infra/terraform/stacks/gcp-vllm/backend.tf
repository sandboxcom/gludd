...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/gcp-vllm"
    lock_address = "http://localhost:8400/api/terraform/state/gcp-vllm"
    unlock_address = "http://localhost:8400/api/terraform/state/gcp-vllm"
  }
}
