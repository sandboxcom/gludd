...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/gcp-llamacpp"
    lock_address = "http://localhost:8400/api/terraform/state/gcp-llamacpp"
    unlock_address = "http://localhost:8400/api/terraform/state/gcp-llamacpp"
  }
}
