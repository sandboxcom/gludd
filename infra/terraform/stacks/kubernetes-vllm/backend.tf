...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/kubernetes-vllm"
    lock_address = "http://localhost:8400/api/terraform/state/kubernetes-vllm"
    unlock_address = "http://localhost:8400/api/terraform/state/kubernetes-vllm"
  }
}
