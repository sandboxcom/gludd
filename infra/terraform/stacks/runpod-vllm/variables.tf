...
variable "region" {
  description = "RunPod region/zone the stack deploys into."
  type        = string
  default     = "US"
}

variable "instance_type" {
  description = "RunPod pod/GPU type. Resolved by the stack from GPU type; passed through here for tagging/labeling."
  type        = string
