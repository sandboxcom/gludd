...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/runpod-vllm"
    lock_address = "http://localhost:8400/api/terraform/state/runpod-vllm"
    unlock_address = "http://localhost:8400/api/terraform/state/runpod-vllm"
  }
}
