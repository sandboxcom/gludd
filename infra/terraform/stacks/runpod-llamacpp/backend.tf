...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/runpod-llamacpp"
    lock_address = "http://localhost:8400/api/terraform/state/runpod-llamacpp"
    unlock_address = "http://localhost:8400/api/terraform/state/runpod-llamacpp"
  }
}
