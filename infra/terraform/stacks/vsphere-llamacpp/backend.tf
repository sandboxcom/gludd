...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/vsphere-llamacpp"
    lock_address = "http://localhost:8400/api/terraform/state/vsphere-llamacpp"
    unlock_address = "http://localhost:8400/api/terraform/state/vsphere-llamacpp"
  }
}
