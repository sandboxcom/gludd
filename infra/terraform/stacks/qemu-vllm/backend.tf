...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/qemu-vllm"
    lock_address = "http://localhost:8400/api/terraform/state/qemu-vllm"
    unlock_address = "http://localhost:8400/api/terraform/state/qemu-vllm"
  }
}
