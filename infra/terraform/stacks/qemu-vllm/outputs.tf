...
output "inference_url" {
  description = "OpenAI-compatible vLLM inference endpoint URL."
...
output "serve_command" {
  description = "The vLLM docker run command deployed to the VM."
  value       = module.vllm_server.serve_command
}
