...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/kubernetes-llamacpp"
    lock_address = "http://localhost:8400/api/terraform/state/kubernetes-llamacpp"
    unlock_address = "http://localhost:8400/api/terraform/state/kubernetes-llamacpp"
  }
}
