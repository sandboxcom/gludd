...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/azure-container-app-vllm"
    lock_address = "http://localhost:8400/api/terraform/state/azure-container-app-vllm"
    unlock_address = "http://localhost:8400/api/terraform/state/azure-container-app-vllm"
  }
}
