...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/azure-llamacpp"
    lock_address = "http://localhost:8400/api/terraform/state/azure-llamacpp"
    unlock_address = "http://localhost:8400/api/terraform/state/azure-llamacpp"
  }
}
