...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/vast-llamacpp"
    lock_address = "http://localhost:8400/api/terraform/state/vast-llamacpp"
    unlock_address = "http://localhost:8400/api/terraform/state/vast-llamacpp"
  }
}
