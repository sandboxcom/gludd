...
variable "region" {
  description = "Vast.ai region/zone the stack deploys into."
  type        = string
  default     = "global"
}

variable "instance_type" {
  description = "Vast.ai machine profile. Resolved by the stack from GPU type; passed through here for tagging/labeling."
  type        = string
  default     = "RTX_4090"
}
