...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/aws-llamacpp"
    lock_address = "http://localhost:8400/api/terraform/state/aws-llamacpp"
    unlock_address = "http://localhost:8400/api/terraform/state/aws-llamacpp"
  }
}
