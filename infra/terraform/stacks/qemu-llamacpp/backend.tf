...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/qemu-llamacpp"
    lock_address = "http://localhost:8400/api/terraform/state/qemu-llamacpp"
    unlock_address = "http://localhost:8400/api/terraform/state/qemu-llamacpp"
  }
}
