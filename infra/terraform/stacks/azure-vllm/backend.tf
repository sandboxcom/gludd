...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/azure-vllm"
    lock_address = "http://localhost:8400/api/terraform/state/azure-vllm"
    unlock_address = "http://localhost:8400/api/terraform/state/azure-vllm"
  }
}
