...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/vast-vllm"
    lock_address = "http://localhost:8400/api/terraform/state/vast-vllm"
    unlock_address = "http://localhost:8400/api/terraform/state/vast-vllm"
  }
}
