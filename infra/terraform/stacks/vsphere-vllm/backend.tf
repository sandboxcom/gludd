...
terraform {
  backend "http" {
    address = "http://localhost:8400/api/terraform/state/vsphere-vllm"
    lock_address = "http://localhost:8400/api/terraform/state/vsphere-vllm"
    unlock_address = "http://localhost:8400/api/terraform/state/vsphere-vllm"
  }
}
