...
<!-- T-BETA3-OPENCode additional path registration: .opencode/scripts/verify-plugins.mjs tests/e2e/test_opencode_plugin_load.py docs/opencode-plugin-configuration-evidence.md -->
<!-- T-BETA3-OPENCode hot-reload registration: .opencode/lib/hot_reload.ts scripts/build_hot_modules.js tests/unit/test_hot_reload_module.py tests/unit/test_hot_reload_proxy.py -->
