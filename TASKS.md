...
- [ ] T-BETA3-CONCURRENT-PROJECT-WORKERS — Deterministic E2E stress coverage for bounded gate/test/audit workers across isolated projects without cross-project lock contention | priority: medium | effort: M | status: pending
...
<!-- T-BETA3-CONCURRENT-PROJECT-WORKERS paths: tests/e2e/test_concurrent_project_workers_e2e.py -->
