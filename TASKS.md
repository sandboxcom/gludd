...
- [ ] T-BETA3-GIT-CHERRYPICK-PREFLIGHT — Fail closed before cherry-picking commits that overlap locally modified shared files; preserve clean-tree and conflict diagnostics | paths: Makefile tests/unit/test_git_workflow_targets.py | priority: high | effort: S | status: pending
