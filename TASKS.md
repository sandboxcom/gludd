...
- [ ] SEC.1 — Implement the complete configurable security and sandbox hardening specification, close every open D-08–D-30 control, and reduce SAST to zero high/medium with every low fixed or time-bounded by tested adjudication | paths: `docs/specs/FEATURE_SECURITY_SANDBOX_HARDENING.md`, `docs/security/audit-observability.md`, `scripts/summarize_sast.py`, `src/general_ludd/ansible/unsafe.py`, `src/general_ludd/ansible/runner.py`, `src/general_ludd/ansible/templating.py`, `src/general_ludd/mcp/transport.py`, `src/general_ludd/security/security_backlog.py`, `tests/unit/test_ansible_extravars_validation.py`, `tests/unit/test_mcp_transport.py`, `tests/unit/test_mcp_transport_stderr.py`, `tests/unit/test_security_audit_observability.py`, `tests/unit/test_security_backlog.py`, `tests/unit/test_security_sandbox_hardening_spec.py` | evidence: bounded audit completed in 54.798s with heartbeats and clean secrets/dependencies; D-08 and D-24 are now regression-probed, reducing backlog from 8 landed/16 open to 10 landed/14 open; 61 focused D-08/backlog tests and 21 focused D-24 tests pass, scoped Ruff/mypy green; SAST is 0 high/34 medium/506 low, with only the active B108 secure-state migration remaining at medium severity; full repository gate pending | priority: high | effort: XL | status: in_progress
