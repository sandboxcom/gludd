...
- [ ] S53.39 — ServiceNow connector display wrapper type safety| priority: medium | effort: S | status: in_progress | paths: src/general_ludd/connectors/servicenow.py, tests/unit/test_connector_servicenow_display_types.py
