...
- [ ] S83.12 — **Fail-closed numerical contract hardening**: reject booleans/non-finite mechanics inputs and restore materials, HyperLogLog, MinHash, and t-digest invariants. | evidence: cached failed-first replay reproduced 26 failures; repair pending | priority: high | effort: L | status: in_progress
