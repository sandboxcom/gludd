...
- [ ] **Ship v0.1.0-beta.2** — after this CI-fix commit lands and CI goes green on master HEAD, run `make release-cut TAG='v0.1.0-beta.2' MSG='Release v0.1.0-beta.2'`, then `make verify-release-artifact TAG='v0.1.0-beta.2'`. Blocked on CI green for the fix-forward commit.
