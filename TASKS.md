...
- [ ] T-BETA3-E2E-PARALLEL-FILES — Run deterministic E2E shard files with bounded parallel workers and per-file artifacts | paths: Makefile scripts/e2e_supervisor.py tests/unit/test_e2e_runner_target.py tests/unit/test_e2e_supervisor.py | priority: high | effort: M | status: in_progress | evidence: focused tests pending
