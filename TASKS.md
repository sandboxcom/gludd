...
<!-- T-BETA3 path registrations: T-BETA3-OPENCode=.opencode/plugin/impl/enforce_make_impl.ts scripts/check_opencode_integrity.py tests/unit/test_opencode_integrity.py; T-BETA3-COVERAGE=scripts/audit_coverage.py tests/unit/test_audit_coverage.py src/general_ludd/ansible/paths.py src/general_ludd/connectors/cassandra_stats.py src/general_ludd/connectors/circleci.py src/general_ludd/connectors/gcp_observability.py src/general_ludd/connectors/jenkins.py src/general_ludd/connectors/pagerduty.py src/general_ludd/connectors/searx.py src/general_ludd/connectors/slack.py src/general_ludd/connectors/prom_scrape.py; T-BETA3-PROVIDER-HARNESS=tests/unit/test_provider_smoke_harness.py -->
