...
- [ ] A.4 — Cut v0.1.0-beta.2 release: `make release-cut` + verify-release-artifact | priority: high | effort: small | status: BLOCKED on CI (2026-07-16, Session 45 update) | blocker: CI run `29481378611` PENDING on development HEAD `2311571c` (10 commits not pushed `2f2d66ff..2311571c`); Session 45 landed 7 commits: NF.4 molecule scenarios (c3a5dceb), molecule verify.yml fixes (510b4cd0, 1e6059f4, 3ae25f04, 2311571c — 11 CI failures fixed), language e2e target test (585e276d), NF.8+NF.10 spec docs (b81e0c04); release-cut cannot proceed until CI verdict is GREEN on the development tip, then development→master merge + `make release-cut TAG=v0.1.0-beta.2` | history: re-opened 2026-07-14 audit — was ticked `[x]` while its own evidence string read "beta.2 SKIPPED — release-cut was started but beta.2 tag was not pushed." A release that was not cut is not a completed release-cut item. Decide explicitly: either cut beta.2 once CI is green, or close as SUPERSEDED by A.9 (v0.1.0-beta.1 shipped) with that rationale written here.
