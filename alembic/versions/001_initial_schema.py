...
def downgrade() -> None:
    ...
    op.drop_index("ix_bucket_leases_bucket_key", table_name="bucket_leases")
    op.drop_table("bucket_leases")
    op.drop_index("ix_variable_values_namespace_id", table_name="variable_values")
    ...
    op.drop_index("ix_task_returns_status", table_name="task_returns")
    op.drop_index("ix_task_returns_queue", table_name="task_returns")
    op.drop_index("ix_task_returns_job_id", table_name="task_returns")
    op.drop_index("ix_task_returns_todo_id", table_name="task_returns")
    op.drop_table("task_returns")
    op.drop_index("ix_todo_events_todo_id", table_name="todo_events")
    op.drop_table("todo_events")
    op.drop_index("ix_todos_status_queue", table_name="todos")
    op.drop_index("ix_todos_queue", table_name="todos")
