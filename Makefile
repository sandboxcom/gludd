...
test-azure-containerapp-coverage:
	@$(MAKE) --no-print-directory coverage-files \
		COVERAGE_TESTFILES='tests/unit/test_azure_accelerator_credentials.py tests/unit/test_azure_containerapp_arm.py tests/unit/test_azure_containerapp_environment_lifecycle.py tests/unit/test_azure_containerapp_environment_make_runtime.py tests/unit/test_azure_containerapp_environment_preflight.py tests/unit/test_azure_containerapp_environment_terraform.py tests/unit/test_azure_containerapp_gpu.py tests/unit/test_azure_containerapp_live_proof.py tests/unit/test_azure_containerapp_make_runtime.py tests/unit/test_azure_containerapp_preflight.py tests/unit/test_azure_containerapp_preflight_cli.py tests/unit/test_azure_containerapp_terraform_phase.py tests/unit/test_azure_containerapp_topology.py tests/unit/test_azure_containerapp_tfvars.py tests/unit/test_deployment_telemetry.py tests/unit/test_provider_auth.py tests/unit/test_self_improve_azure_containerapp_backend.py tests/e2e/test_azure_containerapp_live_proof_cli.py' \
