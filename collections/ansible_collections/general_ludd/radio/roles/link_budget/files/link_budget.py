...
_COLLECTION_ROOT = Path(__file__).resolve()
for _i in range(4):
    _COLLECTION_ROOT = _COLLECTION_ROOT.parent
...
from antenna_types import antenna_info  # type: ignore[import-not-found]
from propagation_models import (  # type: ignore[import-not-found]
    free_space_loss,
    predict_path_loss,
    rain_attenuation,
)
